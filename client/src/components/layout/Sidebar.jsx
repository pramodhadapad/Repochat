...
const Sidebar = () => {
  ...
  return (
    <aside className={`h-screen border-r border-slate-800 bg-slate-950 flex flex-col transition-all duration-300 ${collapsed ? 'w-20' : 'w-64'} sticky top-0 hidden md:flex`}>
