...
const ApiKeySetup = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // #region agent log
      fetch('http://127.0.0.1:7327/ingest/ae4e1792-cd45-4205-b37a-b1df07fb2b5a',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'217282'},body:JSON.stringify({sessionId:'217282',location:'ApiKeySetup.jsx:handleSave',message:'Key save success',data:{status:response?.status,provider:response?.data?.provider},timestamp:Date.now(),hypothesisId:'H1'})}).catch(()=>{});
      // #endregion
      // Refetch profile so store has apiKey: true and Dashboard hides setup without full reload
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
        <div className="flex-1">
          ...
          <p className="text-slate-400 mb-6 max-w-md text-sm leading-relaxed">
            Unlock the power of RepoChat. Paste your AI API key below. We encrypt it with **AES-256-GCM** and it never leaves our secure server.
          </p>
          ...
          <div className="relative max-w-md">
            <input 
              ...
              placeholder="sk-ant-xxx or sk-xxx or AIza..."
