...
/**
 * useNavigationGuard provides a multi-layered lockdown:
 ...
 * to allow the app to redirect to the landing page.
 */
const useNavigationGuard = () => {
  ...
  useEffect(() => {
    ...
    const handlePopState = () => {
      ...
      window.history.pushState(null, '', window.location.href);
      toast('Please use the Logout button in Settings to leave the platform.', {
        icon: '🔒',
        duration: 3000,
        id: 'nav-guard-toast'
      });
