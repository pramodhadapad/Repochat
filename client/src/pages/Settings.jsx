        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-8 flex items-center gap-3">
              <span className="material-symbols-outlined text-[#DA291C] text-3xl">settings</span>
              Settings
            </h1>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 space-y-4 shadow-2xl">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    onClick={toggleTheme}
                    className="p-3 bg-black/20 border border-white/[0.08] rounded-xl hover:border-[#DA291C]/50 transition-all flex items-center gap-2 backdrop-blur-sm"
                  >
